...
<body><div class='wrap'><section class='hero'><h1>CASAMBI BRIDGE v0.3.3</h1><div class='sub'>Jungle Control Center • MQTT • BLE • SMB</div><span class='badge'><span class='orb'></span>WEB ONLINE</span><span class='badge'>PORT ${c.webInterfacePort}</span><span class='badge'>TOPIC ${esc(c.baseTopic)}</span></section>
