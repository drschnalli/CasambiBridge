...
<div class='hero'>
  ...
  <div class='sub'>${esc(c.casambiNetworkName.ifBlank { "Bridge Control Center" })} - powered by Sambesi - v0.9.2</div>
...
<section class='card wide historyTools'><input id='historyFilter' placeholder='Filter: wifi, bluetooth, 192.168, Schnuffel, WPA2...' oninput='loadHistory()'><button class='btn ghost' onclick='expandHistory()'>EXPAND ALL</button><button class='btn ghost' onclick='collapseHistory()'>COLLAPSE ALL</button><button class='btn ghost' onclick='clearHistory()'>CLEAR HISTORY</button></section>
