...
<body><div class='wrap'><section class='hero'><h1>CASAMBI BRIDGE v0.5.0</h1><div class='sub'>Jungle Control Center • MQTT • BLE • SMB</div><span class='badge'><span class='orb'></span>WEB ONLINE</span><span class='badge'>PORT ${c.webInterfacePort}</span><span class='badge'>TOPIC ${esc(c.baseTopic)}</span></section>
...
<section class='card'><h2>Signal LEDs</h2><div class='signalGrid'><p><span class='orb'></span>Casambi BLE RX</p><p><span class='orb'></span>Casambi BLE TX</p><p><span class='orb'></span>MQTT Eingang</p><p><span class='orb'></span>MQTT Ausgang</p><p><span class='orb'></span>SMB ${if (c.smbDebugEnabled) "ON" else "OFF"}</p><p><span class='orb'></span>Web ${if (c.webInterfaceEnabled) "ON" else "OFF"}</p></div><p><b>TX Core:</b> counter + 07 + operation</p><p><b>MQTT:</b> ${esc(c.mqttHost)}:${c.mqttPort}</p><a class='btn ghost' href='/backup'>FULL BACKUP SMB</a><a class='btn ghost' href='/dashboard-yaml'>DASHBOARD YAML</a><a class='btn ghost' href='/dashboard-export'>EXPORT DASHBOARD</a></section></div><div class='grid'><section class='card'><h2>Scenes</h2>${sceneButtons(c)}</section><section class='card'><h2>API & Key</h2><p><span class='orb'></span>HEX-Key wird nach Fetch automatisch aus KeyStore gespeichert.</p><a class='btn ghost' href='/fetch-api'>FETCH API</a></section></div>
