...
<div class='hero'>
  ...
  <div class='sub'>${esc(c.casambiNetworkName.ifBlank { "Bridge Control Center" })} - powered by Sambesi - v0.5.4</div>
...
<div class='grid'>
  ...
  <section id='lightCard' class='card lightCard off'><h2>Licht</h2><div class='powerPanel'><div id='powerOrb' class='powerOrb'>OFF</div><div class='powerMeta'><div id='lightStateText' class='stateTitle'>Licht aus</div><div id='brightnessText' class='stateSub'>Brightness 0%</div><div class='bar'><span id='brightnessBar'></span></div></div></div><div class='controlRow'><a id='cmdOn' class='cmdBtn onCmd' href='/command?state=ON'>ON</a><a id='cmdOff' class='cmdBtn offCmd active' href='/command?state=OFF'>OFF</a><a id='cmd40' class='cmdBtn dimCmd' href='/command?state=ON&brightness=102'>40%</a></div></section>
