...
<div class='grid'>
  ...
  <section class='card'><h2>Tools</h2><div class='controlRow'><a class='btn ghost' href='/fetch-api'>API Fetch</a><a class='btn ghost' href='/dashboard-export'>MQTT YAML schreiben</a><a class='btn ghost' href='/dashboard-yaml'>MQTT YAML anzeigen</a><a class='btn ghost' href='/dashboard-direct-export'>Direct YAML schreiben</a><a class='btn ghost' href='/dashboard-direct-yaml'>Direct YAML anzeigen</a><a class='btn ghost' href='/files'>SMB Browser</a><a class='btn ghost' href='/logs'>Live Log</a><a class='btn ghost' href='/scan-tools'>Scan Tools</a><a class='btn ghost' href='/backup'>Backup SMB</a><a class='btn ghost' href='/toggle-ws'>WebSocket ${if (c.webSocketLiveEnabled) "AUS" else "EIN"}</a></div></section>
